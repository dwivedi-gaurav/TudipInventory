                        ...
                        <div class="col-md-6 col-md-offset-3 " style="padding-left:0px">
                              ...
                              <div class="panel panel-default">
                                  ...
                                  <div class="panel-body">
                                    ...
                                    <form action="/add_category" method="post" onsubmit="return validate_addCategory()">
                                      {{csrf_field()}}
                                      <span id="helpBlockAddCategory" class="help-block noMargin noPadding " style="color:red"></span>
